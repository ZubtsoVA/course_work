...
* При увеличении сетки сходимость (в эпохах) еще медленнее

##

* конечные разности через ядра описать их формулами
* перейти к логарифмич шкале
* написать на почту про платформу
